...
// window.fillForm = function (id, title, category, instructor, image, description, price, duration , lessonNum , content) {
...
//     document.getElementById("course-lessons").value = lessonNum;
//     //TODO fill lessons
