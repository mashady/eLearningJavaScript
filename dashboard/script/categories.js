...
function saveCategory(event) {
  ...
  // Update Local Storage with new categories and updated courses
  localStorage.setItem("categories", JSON.stringify(categories));
  localStorage.setItem("courses", JSON.stringify(courses)); // Fix: Ensure courses are saved correctly
